...
<div id="volumeControl">
  ...
  <section id="agradecimientos" class="screen active">
    ...
    <p class="thanks">
      Agradecimientos especiales: 🥺 Al Profesor <strong>Gabriel Baute</strong>
      por instruirnos y guiarnos en cada paso del desarrollo de este proyecto.🤠🤞
    </p>
